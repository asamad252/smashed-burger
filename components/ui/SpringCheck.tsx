...
export default function SpringCheck({
  ...
  const write = (
    ...
    if (
      ...
      tickRef.current.style.strokeDashoffset =
        r.tick;
    }
  ...
  const handlePointerDown =
    (
      ...
      if (
        ...
        rowRef.current.dataset.pressed =
          "";
      }
    };
